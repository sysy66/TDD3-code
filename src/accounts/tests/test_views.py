...
class SendLoginEmailViewTest(TestCase):
    ...
    @patch('accounts.views.send_async_login_email')
    def test_sends_mail_to_address_from_post(self, mock_send_async_login_email):
    ...
    @patch('accounts.views.send_async_login_email')
    def test_sends_link_to_login_using_token_uid(self, mock_send_async_login_email):
        self.client.post('/accounts/send_login_email', data={
            'email': 'edith@example.com'
        })
        token = Token.objects.first()
